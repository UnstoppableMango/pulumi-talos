...
class KubeconfigResult:
    ...
    def client_configuration(self) -> 'outputs.KubeconfigClientConfigurationResult':
        """
    ...
    def kubernetes_client_configuration(self) -> 'outputs.KubeconfigKubernetesClientConfigurationResult':
        """
...
class AwaitableKubeconfigResult(KubeconfigResult):
