...
namespace UnMango.Talos
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/UnstoppableMango/pulumi-talos";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("UnMango.Talos.version.txt");
    ...
    internal sealed class TalosResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
